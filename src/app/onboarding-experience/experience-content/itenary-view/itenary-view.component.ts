...
import { CountryPickerService } from '../../../_services/index';
import { ModalModule, ModalDirective } from "ngx-bootstrap";
import * as _ from 'lodash';

@Component({
    selector: 'itenary-view',
    templateUrl: 'itenary-view.component.html'
})
export class itenaryViewComponent implements OnInit {
